...
MSG msg;
    ...
    SetTimer(
             ...
             1024,              // время в миллисекундах срабатывания таймера
...
HDC	hdc;
static colIndex = 0; // счётчик символов в строке
static rowIndex = 0;    // счётчик строк
    ...
    switch (iMsg) {
        ...
        case WM_TIMER:
            ...
            TextOut(
                    ...
                    100 + colIndex*10, // Х-координата
                    50 + rowIndex*20,     // У-координата
