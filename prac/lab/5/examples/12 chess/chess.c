/****************************************************************************
    ...
    Модуль описывает класс окон, представляющих шахматные фигуры.
...
unsigned int cx,cy;
    ...
    switch (iMsg){
        ...
        case WM_LBUTTONUP:
            ...
            // получить координаты текущего центра
            GetChessCenter (hwnd, &cx, &cy);
            // необходимо переместить в центр текущей клетки
